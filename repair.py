...
def stripinit(complex_mode, numoverlays, valid_x, test_x, poison_x, anon1_x, eye_x, lip_x, sun_x):
  ...
  if(complex_mode != "complex"):
    ...
    model_BadNetAnon1STRIP = keras.models.load_model('anonymous_1_bd_net.h5')
    model_BadNetAnon2STRIP = keras.models.load_model('anonymous_2_bd_net.h5')
    model_BadNetMTMTSTRIP = keras.models.load_model('multi_trigger_multi_target_bd_net.h5')
